...
class Register extends CI_Controller {
    ...
    public function index() {
      ...
      $cek_email = $this->db->get_where('student', $filter);
      if(count($cek_email) > 0){
        $result = array('status'=>'error', 'message'=>'Email sudah terdaftar!');
      } else {
        $data = array(
        ...
        $result = array('status'=>'success', 'message'=>'Berhasil melakukan registrasi, silahkan cek email anda untuk melakukan aktivasi akun!!');
      }
