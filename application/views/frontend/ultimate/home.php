...
?>
  <main id="content" role="main">
    ...
    <div class="u-hero-v1">
      ...
      <div class="js-slick-carousel u-slick"
        ...
        <div class="js-slide bg-img-hero-center" style="background-image: url(<?php echo base_url(); ?>uploads/frontend/slider/<?php echo $slider_images[$i]->image;?>);">
          <div class="text-center space-3" style="background: rgba(0, 0, 0, 0.5);">
            <h2 class="text-white font-weight-light mb-2"
                data-scs-animation-in="fadeInUp" style="padding-top: 90px;">
            ...
            <a href="#about" data-scs-animation-in="fadeInUp" data-scs-animation-delay="200" type="button" id="mulai" class="btn btn-rounded btn-success">Mulai Jelajah</a>
          </div>
        </div>
        <?php } ?>
    ...
    ?>
      <!-- ========== HEADER ========== -->
      <!-- <div class="u-header__section bg-light"> -->
        <div class="bg-light position-sticky" style="position:sticky; top:0px; z-index:1;">
          <!-- <nav class="js-mega-menu navbar navbar-expand-md u-header__navbar u-header__navbar--no-space fixed-top"> -->
          <nav class="navbar navbar-expand-sm bg-light navbar-dark" style="padding-top: 0px !important; padding-bottom: 0px !important;">
        ...
        <div class="row justify-content-between align-items-center">
          <div class="col-lg-7 mb-7 mb-lg-0">
            <div class="pr-md-4">
              <!-- Title -->
              <div class="mb-7">
                <span class="btn btn-xs btn-soft-success btn-pill mb-2">Sekapur Sirih</span>
              ...
              <a class="btn btn-sm btn-primary btn-wide transition-3d-hover"
                href="<?php echo site_url('home/about');?>">
                  Detail <span class="fas fa-angle-right ml-2"></span></a>
            </div>
          </div>
    ...
    <div class="container space-2 space-md-1">
      ...
      <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-9">
        ...
        <h2 class="text-primary">Guru Profesional Sekolah Kami</span></h2>
      </div>
      <!-- End Title -->
    ...
    <div class="bg-light">
      <div class="container space-2 space-md-1">
        <!-- Title -->
        <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-9">
          <span class="btn btn-xs btn-soft-success btn-pill mb-2">Acara</span>
          <h2 class="text-primary">Acara mendatang</h2>
        </div>
        <!-- End Title -->
