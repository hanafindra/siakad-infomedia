    ...
    <div class="row no-gutters">
      ...
      <div class="col-sm-6 col-lg-3 u-ver-divider u-ver-divider--none-lg">
        ...
        <div class="text-center py-5">
          ...
          <h2 class="h6 mb-0"><?php echo get_phrase('alamat'); ?></h2>
          <p class="mb-0">
      ...
      <div class="col-sm-6 col-lg-3 u-ver-divider u-ver-divider--none-lg">
        ...
        <div class="text-center py-5">
          ...
          <h3 class="h6 mb-0"><?php echo get_phrase('telepon'); ?></h3>
          <p class="mb-0">
    ...
    <div class="w-lg-80 mx-auto">
      ...
      <form action="<?php echo site_url('home/contact/send');?>" method="post" class="js-validate">
        ...
        <div class="text-center">
          <button type="submit" class="btn btn-primary btn-wide transition-3d-hover mb-4">Kirim</button>
        </div>
