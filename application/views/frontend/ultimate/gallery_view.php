...
<main id="content" role="main">
  ...
  <!-- <div class="gradient-half-primary-v1"> -->
    <div class="container text-center space-top-2 space-top-md-2 space-top-lg-1">
  ...
  <div class="container space-2 space-md-2">
    ...
    <div class= u-cubeportfolio">
      ...
      <div class="text-center">
        <a href="<?php echo site_url('home/gallery');?>" type="button" class="btn btn-rounded btn-primary">Kembali</a>
      </div>
      <!-- End Content -->
  </div>
