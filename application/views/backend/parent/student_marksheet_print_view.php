...
<div id="print">
	...
	<center>
		...
		<?php echo get_phrase('lembar_kerja_siswa');?><br>
	...
	<table style="width:100%; border-collapse:collapse;border: 1px solid #ccc; margin-top: 10px;" border="1">
       <thead>
        <tr>
            ...
            <td style="text-align: center;">Tanda yang diperoleh</td>
            <td style="text-align: center;">Tanda tertinggi</td>
...
<br>
    ...
    <center>
	   <?php echo get_phrase('tanda_total');?> : <?php echo $total_marks;?>
	   <br>
	   <?php echo get_phrase('titik_nilai_rata-rata');?> :
	        <?php
