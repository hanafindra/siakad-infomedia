...
<div class="pull-right" style="text-align: right; margin-top: -30px;">
  <a href="<?php echo site_url('parents/message'); ?>" class="btn btn-blue"><i class="fa fa-comment" aria-hidden="true"></i> <?php echo get_phrase('pesan_pribadi'); ?></a>
</div>
<hr />
<div class="mail-env">
    ...
    <div class="mail-sidebar" style="min-height: 800px;">
        ...
        <div class="mail-sidebar-row hidden-xs" style="text-align: center;">
          <button type="button" name="button" class="btn btn-primary btn-block"><?php echo get_phrase('daftar_grup'); ?></button>
        </div>
        ...
        <ul class="mail-menu">
            ...
            <div class="col-sm-12" style="text-align: center; margin-top: 25px; color: #607D8B; font-size: 13px;">
              <?php echo '( '.get_phrase('tidak_ada_grup_yang_dibuat').' )'; ?>
            </div>
            <?php endif; ?>
        </ul>
