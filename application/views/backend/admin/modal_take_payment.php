		...
		<div class="panel panel-primary panel-shadow" data-collapsed="0">
            ...
            <div class="panel-body">
				<?php echo form_open(site_url('admin/invoice/take_payment/'.$row['invoice_id']) , array(
		            ...
		            <div class="form-group">
		                <label class="col-sm-3 control-label"><?php echo get_phrase('jumlah_pembayaran');?></label>
		                <div class="col-sm-6">
		            ...
		            <div class="form-group">
		                <label class="col-sm-3 control-label"><?php echo get_phrase('batas_pembayaran');?></label>
		                <div class="col-sm-6">
