	...
	<div class="col-md-4">
		...
		<div id="student_holder">
			<select class="" name="student_id" id="student_id" disabled>
			    <option value=""><?php echo get_phrase('pilih kelas dan bagian');?></option>
		    </select>
		</div>
	</div>
	<div class="col-md-2">
		<label></label>
		<button type="button" class="btn btn-info btn-block" id="find" style="padding:10px; margin-top:5px;">
			<?php echo get_phrase('cari');?>
		</button>
	</div>
</div>
<hr>
