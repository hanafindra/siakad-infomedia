		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title" >
					...
					<?php echo get_phrase('Tambah bagian');?>
            	</div>
            </div>
			<div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/sections/create/') , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('nama kelas');?></label>
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('guru');?></label>
