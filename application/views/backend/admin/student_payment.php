			...
			<ul class="nav nav-tabs bordered">
				<li class="active">
					<a href="#unpaid" data-toggle="tab">
						<span class="hidden-xs"><?php echo get_phrase('Membuat Satu Kwitansi');?></span>
					</a>
				</li>
				<li>
					<a href="#paid" data-toggle="tab">
						<span class="hidden-xs"><?php echo get_phrase('membuat_kwitansi_massal');?></span>
					</a>
				</li>
			</ul>
					...
					<div class="col-md-6">
	                        <div class="panel panel-primary" data-collapsed="0">
	                            ...
	                            <div class="panel-body">
	                                ...
	                                <div class="form-group">
	                                    <label class="col-sm-3 control-label"><?php echo get_phrase('tujuan');?></label>
	                                    <div class="col-sm-9">
                        ...
                        <div class="panel panel-primary panel-shadow" data-collapsed="0">
                            <div class="panel-heading">
                                <div class="panel-title"><?php echo get_phrase('informasi pembayaran');?></div>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="amount"
                                            placeholder="<?php echo get_phrase('masukkan total ');?>"
                                                data-validate="required" data-message-required="<?php echo get_phrase('data tidak boleh kosong');?>"/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><?php echo get_phrase('jumlah');?></label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="amount_paid"
                                            placeholder="<?php echo get_phrase(' masukkan jumlah yang dibayarkan');?>"
                                                data-validate="required" data-message-required="<?php echo get_phrase('data tidak boleh kosong');?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="status" class="form-control selectboxit">
                                            <option value="paid"><?php echo get_phrase('sudah bayar');?></option>
                                            <option value="unpaid"><?php echo get_phrase('belum bayar');?></option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-5">
                                <button type="submit" class="btn btn-info submit"><?php echo get_phrase('tambah');?></button>
                            </div>
                        </div>
                    </div>
				...
				<div class="col-md-5">
                    ...
                    <div class="form-group">
                        <div class="col-sm-5 col-sm-offset-3">
                            <button type="submit" class="btn btn-info submit2"><?php echo get_phrase('tambah');?></button>
                        </div>
                    </div>
