<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo get_phrase('Pilih daftar hadir kelas') ?></h3>
    </div>
    <div class="panel-body">
        ...
        <div id="section_holder">
            ...
            <div class="col-md-3" style="margin-top: 20px;">
                <button type="submit" id = "submit" class="btn btn-info"><?php echo get_phrase('lihat daftar hadir'); ?></button>
            </div>
...
<div class="row" style="text-align: center;">
    ...
    <div class="col-sm-4">
        <div class="tile-stats tile-white">
            ...
            <h3 style="color: #696969;"><?php echo get_phrase('Daftar hadir kelas'); ?> <?php echo $this->db->get_where('class', array('class_id' => $class_id))->row()->name; ?></h3>
...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo get_phrase('Isi Daftar Hadir') ?></h3>
            </div>
            <div class="panel-body">
                <center>
                    <a class="btn btn-default" onclick="mark_all_present()">
                        <i class="entypo-check"></i> <?php echo get_phrase('hadir Semua'); ?>
                    </a>
                    <a class="btn btn-default"  onclick="mark_all_absent()">
                        <i class="entypo-cancel"></i> <?php echo get_phrase('Bolos semua'); ?>
                    </a><br><br>
                </center>
                        ...
                        <tbody>
                            ...
                            foreach ($attendance_of_students as $row):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" name="status_<?php echo $row['attendance_id']; ?>" value="0" <?php if ($row['status'] == 0) echo 'checked'; ?>>&nbsp;<?php echo get_phrase('izin'); ?> &nbsp;
                                        <input type="radio" name="status_<?php echo $row['attendance_id']; ?>" value="1" <?php if ($row['status'] == 1) echo 'checked'; ?>>&nbsp;<?php echo get_phrase('hadir'); ?> &nbsp;
                                        <input type="radio" name="status_<?php echo $row['attendance_id']; ?>" value="2" <?php if ($row['status'] == 2) echo 'checked'; ?>>&nbsp;<?php echo get_phrase('bolos'); ?> &nbsp;
                                    </td>
                                </tr>
                            <?php
                            $select_id++;
                ...
                <center>
                    <button type="submit" class="btn btn-success" id="submit_button">
                        <i class="entypo-thumbs-up"></i> <?php echo get_phrase('simpan'); ?>
                    </button>
                </center>
                <?php echo form_close(); ?>
            </div>
