	...
	<div class="col-md-12">
		<div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo get_phrase('Tambah Jadwal Baru') ?></h3>
            </div>
            <div class="panel-body">
                <?php echo form_open(site_url('admin/class_routine/create') , array('class' => 'form-horizontal form-groups validate','target'=>'_top'));?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><?php echo get_phrase('hari');?></label>
                        <div class="col-sm-5">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><?php echo get_phrase('waktu mulai');?></label>
                        <div class="col-sm-9">
                            <div class="col-md-3">
                                <select name="time_start" id= "starting_hour" class="form-control selectboxit">
                                    <option value=""><?php echo get_phrase('jam');?></option>
                                    <?php for($i = 0; $i <= 24 ; $i++):?>
                            ...
                            <div class="col-md-3">
                                <select name="time_start_min" id= "starting_minute" class="form-control selectboxit">
                                    <option value=""><?php echo get_phrase('menit');?></option>
                                    <?php for($i = 0; $i <= 24 ; $i++):?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><?php echo get_phrase('waktu berakhir');?></label>
                        <div class="col-sm-9">
                            <div class="col-md-3">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" id= "add_class_routine" class="btn btn-info"><?php echo get_phrase('tambah');?></button>
                        </div>
                    </div>
                <?php echo form_close();?>
            </div>
