            ...
            <div class="panel panel-primary" >
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <?php echo get_phrase('Pengaturan_sistem');?>
                    </div>
                </div>
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo get_phrase('judul aplikasi');?></label>
                      <div class="col-sm-9">
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo get_phrase('no telpon');?></label>
                      <div class="col-sm-9">
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo get_phrase('mata uang');?></label>
                      <div class="col-sm-9">
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo get_phrase('bahasa');?></label>
                      <div class="col-sm-9">
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo get_phrase('kode bayar');?></label>
                      <div class="col-sm-9">
                ...
                <div class="panel panel-primary" >
                  ...
                  <div class="panel-body">
                    ...
                    <div class="panel panel-primary" data-collapsed="0">
                      ...
                      <div class="panel-heading">
                          <div class="panel-title">
                              <?php echo get_phrase('Ubah Produk');?>
                          </div>
                      </div>
                          ...
                          <?php echo form_open(site_url('updater/update') , array('class' => 'form-horizontal form-groups-bordered', 'enctype' => 'multipart/form-data'));?>
                              ...
                              <div class="form-group">
                                  <div class="col-sm-offset-3 col-sm-5">
                                      <input type="submit" class="btn btn-info" value="<?php echo get_phrase('simpan'); ?>" />
                                  </div>
                              </div>
