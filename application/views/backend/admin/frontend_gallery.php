<ul class="nav nav-tabs bordered">
	<li class="active">
		<a href="#tab1" data-toggle="tab">
			...
			<span class="hidden-xs"><?php echo get_phrase('daftar galery'); ?></span>
		</a>
	</li>
	<li class="">
		<a href="#tab2" data-toggle="tab">
			<span class="visible-xs"><i class="entypo-plus"></i></span>
			<span class="hidden-xs"><?php echo get_phrase('tambah'); ?></span>
		</a>
	</li>
</ul>
...
<div class="tab-content">
	<div class="tab-pane active" id="tab1" style="margin-top: 20px;">
		<table class="table table-bordered datatable" id="table_export">
			<thead>
				<tr>
					<th><div>#</div></th>
					<th><div><?php echo get_phrase('nama_galeri');?></div></th>
										...
										<li>
												<a href="<?php echo site_url('admin/frontend_pages/gallery_image/'.$row['frontend_gallery_id']);?>">
													<i class="entypo-eye"></i>
														<?php echo get_phrase('lihat galeri');?>
											</a>
										</li>
										<li class="divider"></li>
											<!-- EDITING LINK -->
    ...
    <form class="form-horizontal form-groups" method="post"
      ...
      <div class="form-group">
				...
				<div class="col-sm-7">
					<input type="text" class="form-control" name="title" placeholder="<?php echo get_phrase('nama galeri');?>" required>
				</div>
			</div>
      <div class="form-group">
      ...
      <div class="form-group">
        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('gambar cover');?></label>
        <div class="col-sm-7">
      ...
      <div class="form-group">
        <label class="col-sm-3 control-label"><?php echo get_phrase('tampilkan di web'); ?></label>
        <div class="col-sm-4">
