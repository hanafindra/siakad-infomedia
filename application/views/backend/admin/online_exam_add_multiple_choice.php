...
<div class="form-group" id='multiple_choice_question'>
    ...
    <div class="col-sm-8">
        <div class="input-group">
          <input type="number" class="form-control" name="number_of_options" id = "number_of_options" data-validate="required" data-message-required="<?php echo get_phrase('nilai_dibutuhkan');?>" min="0"/>
