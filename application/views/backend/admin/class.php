		...
		<ul class="nav nav-tabs bordered">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i>
					<?php echo get_phrase('semua kelas');?>
                    	</a></li>
			<li>
            	<a href="#add" data-toggle="tab"><i class="entypo-plus-circled"></i>
					<?php echo get_phrase('tambah kelas');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------>
            ...
            <div class="tab-pane box active" id="list">
                ...
                <table class="table table-bordered datatable" id="">
                	<thead>
                		<tr>
                    		<th><div>#</div></th>
                    		<th><div><?php echo get_phrase('nama kelas');?></div></th>
                    		<th><div><?php echo get_phrase('id kelas');?></div></th>
                	...
                	<?php echo form_open(site_url('admin/classes/create') , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('nama kelas');?></label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('Kelas No');?></label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="teacher_id" class="form-control select2" style="width:100%;" data-validate="required" data-message-required="<?php echo get_phrase('data tidak boleh kosong');?>">
                                        <option value=""><?php echo get_phrase('pilih guru');?></option>
                                    	<?php
