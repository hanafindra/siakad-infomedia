<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo get_phrase('Pilih kelas') ?></h3>
    </div>
			...
			<div class="col-md-12">
				<?php echo form_open(site_url('admin/tabulation_sheet'));?>
					...
					<div class="col-md-4">
						...
						<label class="control-label"><?php echo get_phrase('ujian');?></label>
							<select name="exam_id" class="form-control selectboxit" id = 'exam_id'>
		                        <option value=""><?php echo get_phrase('pilih ujian');?></option>
		                        <?php
					...
					<div class="col-md-4" style="margin-top: 20px;">
						<button type="submit" id = 'submit' class="btn btn-info"><?php echo get_phrase('lihat rapor');?></button>
					</div>
				<?php echo form_close();?>
			</div>
		</div>
		...
		<div class="icon"><i class="entypo-docs"></i></div>
			<h3 style="color: #696969;">
				<?php
					...
					echo get_phrase('rapor');
				?>
			</h3>
			<h4 style="color: #696969;">
				<?php echo get_phrase('kelas') . ' ' . $class_name;?> : <?php echo $exam_name;?>
			</h4>
		</div>
	</div>
	<div class="col-md-4"></div>
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo get_phrase('rapor') ?></h3>
    </div>
    <div class="panel-body">
    	<div class="row">
			<div class="col-md-12">
				<table class="table table-bordered">
					<thead>
						...
						<td style="text-align: center;">
							<?php echo get_phrase('siswa');?> <i class="entypo-down-thin"></i> | <?php echo get_phrase('materi');?> <i class="entypo-right-thin"></i>
						</td>
						<?php
						...
						<td style="text-align: center;"><?php echo get_phrase('rata-rata');?></td>
						</tr>
					</thead>
					<tbody>
					<?php
				...
				<center>
					<a href="<?php echo site_url('admin/tabulation_sheet_print_view/'.$class_id.'/'.$exam_id);?>"
						...
						<?php echo get_phrase('cetak rapor');?>
					</a>
				</center>
			</div>
		</div>
