...
<ul class="nav nav-tabs bordered">
  <li class="active">
    <a href="#tab1" data-toggle="tab">
      ...
      <span class="hidden-xs"><?php echo get_phrase('Slider Gambar Landingpage'); ?></span>
    </a>
  </li>
</ul>
          ...
          <div class="row" style="margin-top: 20px;">
            <div class="col-md-7">
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="title_<?php echo $i;?>" placeholder="<?php echo get_phrase('nama');?>"
            ...
            <div class="col-md-5">
              <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('gambar slide');?></label>
                <div class="col-sm-9">
