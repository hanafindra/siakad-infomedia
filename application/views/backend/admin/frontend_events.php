<ul class="nav nav-tabs bordered">
	<li class="active">
		<a href="#tab1" data-toggle="tab">
			...
			<span class="hidden-xs"><?php echo get_phrase('daftar_acara'); ?></span>
		</a>
	</li>
	<li class="">
...
<div class="tab-content">
	<div class="tab-pane active" id="tab1" style="margin-top: 20px;">
		<table class="table table-bordered datatable" id="table_export">
			<thead>
				<tr>
					<th><div>#</div></th>
					<th><div><?php echo get_phrase('nama acara');?></div></th>
    ...
    <form class="form-horizontal form-groups" method="post"
      ...
      <div class="form-group">
            ...
            <option value="0"><?php echo get_phrase('tidak aktif'); ?></option>
            <option value="1"><?php echo get_phrase('aktif'); ?></option>
					</select>
				</div>
			</div>
      <div class="form-group">
