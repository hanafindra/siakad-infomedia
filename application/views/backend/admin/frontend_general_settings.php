<ul class="nav nav-tabs bordered">
  <li class="active">
    <a href="#tab1" data-toggle="tab">
      ...
      <span class="hidden-xs"><?php echo get_phrase('pengaturan umum'); ?></span>
    </a>
  </li>
</ul>
      ...
      <div class="col-md-12">
        <form class="form-horizontal form-groups" method="post"
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label"><?php echo get_phrase('nama sekolah'); ?></label>
            <div class="col-sm-7">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label"><?php echo get_phrase('email sekolah'); ?></label>
            <div class="col-sm-7">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label"><?php echo get_phrase('no telepone'); ?></label>
            <div class="col-sm-7">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label"><?php echo get_phrase('teks copyright'); ?></label>
            <div class="col-sm-7">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label"><?php echo get_phrase('Google Code'); ?></label>
            <div class="col-sm-7">
          ...
          <!-- getting the social links -->
          <div class="form-group">
            <label class="col-sm-3 control-label"><?php echo get_phrase('sosial media'); ?></label>
            <div class="col-sm-7">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label"><?php echo get_phrase('tema web'); ?></label>
            <div class="col-sm-7">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label"><?php echo get_phrase('catatan_judul_homepage'); ?></label>
            <div class="col-sm-7">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label"><?php echo get_phrase('deskripsi homepage'); ?></label>
            <div class="col-sm-7">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7">
              <button type="submit" class="btn btn-success">
                <i class="entypo-check"></i> &nbsp; <?php echo get_phrase('simpan'); ?>
              </button>
            </div>
          </div>
        </form>
