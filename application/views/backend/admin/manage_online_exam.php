        ...
        <table  class="table table-bordered datatable" id="table_export">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php
                            echo '<b>'.get_phrase('kelas').':</b> '.$this->db->get_where('class', array('class_id' => $row['class_id']))->row()->name.'<br/><b>'.get_phrase('sesi').':</b> '.$this->db->get_where('section', array('section_id' => $row['section_id']))->row()->name;
                        ?>
                    </td>
                    <td>
                        <?php
                    ...
                    <td>
                        <?php
                            echo '<b>'.get_phrase('tanggal').':</b> '.date('M d, Y', $row['exam_date']).'<br>'.'<b>'.get_phrase('waktu').':</b> '.$row['time_start'].' - '.$row['time_end'];
                        ?>
                    </td>
                    <td>
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            ...
                            <li>
                                <a href="<?php echo site_url('admin/manage_online_exam_question/').$row['online_exam_id']; ?>">
                                    ...
                                    <?php echo get_phrase('Setting Pertanyaan');?>
                                </a>
                            </li>
                            <!-- EDITING LINK -->
                            <li>
                                <a href="<?php echo site_url('admin/update_online_exam/').$row['online_exam_id']; ?>" >
                                    ...
                                    <?php echo get_phrase('Edit Info Ujian');?>
                                </a>
                            </li>
                            <li class="divider"></li>
                    ...
                    <?php elseif ($row['status'] == 'published'): ?>
                        <a href="#" onclick="confirm_modal('<?php echo site_url('admin/manage_online_exam_status/'.$row['online_exam_id'].'/expired'); ?>', 'generic_confirmation');" type="button" class = "btn btn-danger btn-sm"><i class="fa fa-times" aria-hidden="true"></i> <?php echo get_phrase('batalkan'); ?></a>
                    <?php elseif($row['status'] == 'expired'): ?>
                        <a href="#" type="button" class = "btn btn-primary btn-sm"><i class="fa fa-ban" aria-hidden="true"></i> <?php echo get_phrase('expired'); ?></a>
                    <?php endif; ?>

                    <a href="<?php echo site_url('admin/view_online_exam_result/'.$row['online_exam_id']); ?>" type="button" class = "btn btn-primary"><i class="fa fa-eye" aria-hidden="true"></i> <?php echo get_phrase('lihat hasil'); ?></a>
                    </td>
                </tr>
                <?php endforeach;?>
            </tbody>
