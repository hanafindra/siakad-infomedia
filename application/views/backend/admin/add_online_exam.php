    ...
    <?php echo form_open(site_url('admin/manage_online_exam/create') , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
            ...
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title" >
                        ...
                        <?php echo get_phrase('Ujian Online');?>
                    </div>
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><?php echo get_phrase('nama ujian');?></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="exam_title" data-validate="required" data-message-required="<?php echo get_phrase('tidak boleh kosong');?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            data-message-required="<?php echo get_phrase('tidak boleh kosong');?>"
                    ...
                    <div class="form-group">
                        <label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('sesi');?></label>
                    ...
                    <div class="form-group">
                        <label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('materi');?></label>
        ...
        <div class="col-md-6">
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><?php echo get_phrase('tanggal ujian');?></label>
                        <div class="col-sm-9">
                            <input type="text" class="datepicker form-control" name="exam_date" data-validate="required" data-message-required="<?php echo get_phrase('tidak boleh kosong');?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><?php echo get_phrase('waktu ujian');?></label>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-1"><h5><strong><?php echo get_phrase('sampai');?></strong></h5></div>
                        <div class="col-sm-4">
                            <div class="input-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><?php echo get_phrase('nilai minimum');?></label>
                        <div class="col-sm-9">
                            <label class="sr-only" for="exampleInputAmount"><?php echo get_phrase('nilai minimum'); ?></label>
                            <div class="input-group">
                              <input type="text" class="form-control" name = "minimum_percentage" id="exampleInputAmount" placeholder="<?php echo get_phrase('nilai minimum'); ?>" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" required>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><?php echo get_phrase('instruksi');?></label>
                        <div class="col-sm-9">
                            <textarea name="instruction" class = "form-control" rows="8" cols="80" data-validate="required" data-message-required="<?php echo get_phrase('tidak boleh kosong');?>" required></textarea>
                        </div>
                    </div>
                </div>
            </div>
