        ...
        <?php echo form_open(site_url('admin/noticeboard/do_update/'.$row['notice_id']), array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        ...
                        <div class="box closable-chat-box">
                            <div class="box-content padded">
                                    ...
                                    <textarea name="notice" id="ttt" rows="5" class="form-control"
                                    	placeholder="<?php echo get_phrase('tambah_pengumuman');?>" required><?php echo $row['notice'];?></textarea>
                                    </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <span class="badge badge-primary">
                            <?php
                                ...
                                if ($active_sms_service == '' || $active_sms_service == 'disabled')
                                    echo get_phrase('layanan_sms_dinonaktifkan');
                            ?>
                        </span>
                    </div>
                </div>
            ...
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-5">
                  <button type="submit" class="btn btn-info"><?php echo get_phrase('ubah_pengumuman');?></button>
              </div>
            </div>
        </form>
        <?php endforeach;?>
