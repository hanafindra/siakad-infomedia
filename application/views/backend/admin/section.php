<a href="javascript:;" onclick="showAjaxModal('<?php echo site_url('modal/popup/section_add/');?>');"
	class="btn btn-primary pull-right">
    	<i class="entypo-plus-circled"></i>
			<?php echo get_phrase('Tambah Bagian Kelas');?>
</a>
<br><br><br>
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-primary">
		    <div class="panel-heading">
		        <h3 class="panel-title"><?php echo get_phrase('Wali Kelas') ?></h3>
		    </div>
						...
						<div class="tab-pane active">
							<table class="table table-bordered responsive">
								<thead>
									<tr>
										<th>#</th>
										<th><?php echo get_phrase('nama bagian');?></th>
										<th><?php echo get_phrase('nama kelas');?></th>
