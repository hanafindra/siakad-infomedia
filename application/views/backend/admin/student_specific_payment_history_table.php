...
<h4 class="text-muted" style="margin-bottom: 20px;">
	<?php echo get_phrase('riwayat pembayaran'); ?> <?php echo $this->db->get_where('student', array('student_id' => $student_id))->row()->name; ?>
</h4>
<?php endif; ?>
	        ...
	        <tr>
	            ...
	            <td align="center">
	            	<a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/modal_view_invoice/'.$row['invoice_id']);?>')">
	            			<i class="entypo-credit-card"></i>&nbsp;<?php echo get_phrase('lihat');?>
	            	</a>
	            </td>
	        </tr>
        <?php endforeach; ?>
